...
# Example special workspace (scratchpad)
      ...
      windowrule = [
        ...
        "match:class ^(org.pulseaudio.pavucontrol|nm-connection-editor|.blueman-manager-wrapped|thunderbird)$, float on"
        "match:class ^(org.pulseaudio.pavucontrol|nm-connection-editor|.blueman-manager-wrapped)$, size 700 500"
        "match:class ^(thunderbird)$, size 1280 900"
        "match:class ^(org.pulseaudio.pavucontrol|nm-connection-editor|.blueman-manager-wrapped|thunderbird)$, center on"
